...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.MyViewHolder>{
    ...
    public RecyclerViewAdapter(ArrayList<Friends> friendsList, Activity mAct) {
...
//            imageViewFriend = itemView.findViewById(R.id.imageViewFriendPicture);
            textViewFriendName = itemView.findViewById(R.id.textView4);
            textViewdateFriend = itemView.findViewById(R.id.textView5);
            textViewCity = itemView.findViewById(R.id.textView6);
        }
    }
}
